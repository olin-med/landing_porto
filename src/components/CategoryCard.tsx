...
type CategoryCardProps = {
  ...
  mobileScrollTargetId: string; // Optional, for mobile-specific scroll target
  desktopScrollTargetId: string; // Optional, for desktop-specific scroll target
};
